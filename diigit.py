...
class TM1637:
    ...
    def numbers(self, num1, num2, colon=True):
        ...
        #my code : don't change int to string. just put in the int array.
        #just for test
        segments =[num1//10,num1%10,num2//10,num2%10]
    ...
    def clockTest(self):
        ...
        self.numbers(t.tm_hour, t.tm_min, True)
        time.sleep(.5)
        self.numbers(t.tm_hour, t.tm_min, False)
